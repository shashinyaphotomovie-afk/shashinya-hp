...
const NAV_ITEMS = ["WORKS", "SERVICE", "WEB", "ABOUT", "CONTACT"];
...
export default function App() {
  return (
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Shashinya />} />
        <Route path="/web-service" element={<WebServicePage />} />
      </Routes>
    </BrowserRouter>
  );
}
      ...
      <section id="service" style={{ padding: "100px 32px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 12, color: "rgba(240,237,232,0.5)", marginBottom: 24, lineHeight: 1.8 }}>
            撮影でお届けした写真をそのままWebサイトに活用。<br />
            写真・デザイン・制作をワンストップでお任せいただけます。
          </div>
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            {[
              { plan: "SIMPLE", desc: "ランディングページ", price: "¥80,000〜" },
              { plan: "STANDARD", desc: "撮影込み LP（最人気）", price: "¥150,000〜" },
              { plan: "FULL", desc: "複数ページ + 運用", price: "応相談" },
            ].map(p => (
          ...
          <div style={{ marginTop: 28, textAlign: "right" }}>
            <Link to="/web-service" style={{
              fontFamily: "'Bebas Neue', sans-serif",
              fontSize: 13, letterSpacing: "0.25em",
              color: "#c8b89a", textDecoration: "none",
              borderBottom: "1px solid #c8b89a", paddingBottom: 4,
            }}>
              VIEW DETAILS →
            </Link>
          </div>
